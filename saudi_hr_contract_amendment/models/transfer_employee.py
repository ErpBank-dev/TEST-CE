...
class TransferEmployee(models.Model):
    ...
    branch_id = fields.Many2one('res.branch', 'From Office', readonly=True)
    ...
    new_branch_id = fields.Many2one('res.branch', 'To Office')
    new_analytic_account_id = fields.Many2one('account.analytic.account', string='Analytic Account', track_visibility='onchange')
    new_analytic_tag_ids = fields.Many2many('account.analytic.tag', 'new_account_account_analytic_tag', string='Analytic Tags', track_visibility='onchange')
    state = fields.Selection([
        ...
        ('approve', 'Approved'),
        ('done', 'Done'),
        ('cancel', 'Cancel')], 'State', default='draft', track_visibility='onchange')
