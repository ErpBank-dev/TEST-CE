...
class HrPayslip(models.Model):
    ...
    def send_payslip(self):
        if self.employee_id.work_email:
            template = self.env.ref('sync_hr_payroll.send_payslip_mail', raise_if_not_found=False)
    ...
    def refund_sheet(self):
        ...
        formview_ref = self.env.ref('sync_hr_payroll.view_hr_payslip_form', False)
        treeview_ref = self.env.ref('sync_hr_payroll.view_hr_payslip_tree', False)
        return {
            'name': ("Refund Payslip"),
            'view_mode': 'tree, form',
            'view_id': False,
